(() => {
    ...
    function initSliders() {
        if (document.querySelector(".page-slider__slider")) new core(".page-slider__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".page-testmoinals__slider")) new core(".page-testmoinals__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
        ...
        if (document.querySelector(".page-shop__slider")) new core(".page-shop__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
...
*/
            ...
            try {
                f(u(e), (function(e) {
                    ...
                    if (null !== t) {
                        ...
                        n.callbackTimer && window.clearTimeout(n.callbackTimer.clock), m(n.node, n.styles.inline.generated), 
        ...
        function l(e, t) {
            ...
            if (n) {
                ...
                if (n.models = {
                    ...
                    if (a) return j.call(this, n, r.body[0], -1, t), j.call(this, n, r.body[0], 1, t), 
                    c.call(this, a, {
                        reveal: !0,
                        pristine: t
                    });
                }
                if (!n.blocked.head && i === [].concat(o.head).pop() && i >= [].concat(r.body).shift()) return j.call(this, n, i, -1, t), 
                c.call(this, e, {
                    reveal: !0,
                    pristine: t
                });
                if (!n.blocked.foot && i === [].concat(o.foot).shift() && i <= [].concat(r.body).pop()) return j.call(this, n, i, 1, t), 
                c.call(this, e, {
                    reveal: !0,
                    pristine: t
                });
        ...
        function i(e, a, t) {
            ...
            try {
                ...
                f(i.reduce((function(e, t) {
                    ...
                    i ? (v(n, c.store.elements[i]), m(n.node, n.styles.inline.computed)) : (n.id = b(), 
    ...
    sr.reveal(`.page-main__text, .page-blog__title`, {
        delay: 600
    });
    sr.reveal(`.page-main__btn, .page-blog__text`, {
        delay: 800
    });
    sr.reveal(`.page-slider`, {
        delay: 900,
        origin: "bottom"
    });
    sr.reveal(`.page-slider__title, .footer__about`, {
        origin: "bottom"
    });
    ...
    sr.reveal(`.page-our-rider__image, .page-servises__item, .page-testmoinals__slide, .page-shop__slide`, {
        delay: 600,
        origin: "bottom",
        interval: 150,
        distance: "260px"
